...
public class FastJuicer extends BasicFastMachine {

    public FastJuicer(ItemGroup itemGroup, SlimefunItemStack itemStack, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public RecipeLoader getRecipeLoader() {
        return new SlimefunMultiblockRecipeLoader(this, SlimefunItems.JUICER.getItemId());
    }
}
