...
public class FastGrindStone extends BasicFastMachine {

    public FastGrindStone(ItemGroup itemGroup, SlimefunItemStack itemStack, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public RecipeLoader getRecipeLoader() {
        return new SlimefunMultiblockRecipeLoader(this, SlimefunItems.GRIND_STONE.getItemId());
    }
}
