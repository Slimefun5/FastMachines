...
public class FastSmeltery extends BasicFastMachine {

    public FastSmeltery(ItemGroup itemGroup, SlimefunItemStack itemStack, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public RecipeLoader getRecipeLoader() {
        return new SlimefunMultiblockRecipeLoader(this, SlimefunItems.SMELTERY.getItemId());
    }
}
