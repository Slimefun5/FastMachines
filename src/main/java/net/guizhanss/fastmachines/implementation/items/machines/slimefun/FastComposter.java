...
public class FastComposter extends BasicFastMachine {

    public FastComposter(ItemGroup itemGroup, SlimefunItemStack itemStack, RecipeType recipeType, ItemStack[] recipe) {
        super(itemGroup, itemStack, recipeType, recipe);
    }

    @Override
    public Material getCraftItemMaterial() {
        return MaterialCompat.safe(XMaterial.COMPOSTER);
    }

    @Override
    public RecipeLoader getRecipeLoader() {
        return new SlimefunDisplayRecipeLoader(this, SlimefunItems.COMPOSTER.getItemId());
    }
}
